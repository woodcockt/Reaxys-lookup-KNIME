 ...
 */
public class ReaxysLookupNodePlugin extends Plugin {
	// The shared instance.
	private static ReaxysLookupNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public ReaxysLookupNodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static ReaxysLookupNodePlugin getDefault() {
		return plugin;
	}
